...
<ul class="price-list celled">
  <li class="flex">
      ...
      <div class="w30">
        <div class="btn-wrapper c1 tc">
            <router-link to="/userinfo"><div class="btn c1">购买留言</div></router-link>
  ...
  <div class="price-table container">
    <table class="price-table-detail tc" name="jy" id="jy" v-for="(item,index) in data.list">
        <thead>
...
<script>
import {PriceData} from "../assets/store/data"
export default {
  name: 'Price',
  data () {
    return {
  ...
  tr
    td
      ...
      .support,.unsupport
        height 30px
        width 30px
        background: url('../assets/images/logo.png') -97px -184px no-repeat;
