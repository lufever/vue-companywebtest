...
<div class="product-view">
  <ul class="pro-menu">
  <li v-for="(item,index) in Data.list" @click="showdetail(item,index)" :class="{'active':curindex==index}">
...
<script>
import {ProductData} from "../assets/store/data"
export default {
  name: 'Product',
  data () {
    return {
